        ...
        <div className={NotificationsCSS.gridContainer}>
            <nav className={NotificationsCSS.nav}>
                <ul className={NotificationsCSS.navList}>
                    <li className={[NotificationsCSS.navListItem, NotificationsCSS.navLogoListItem].join(' ')}><Link className={NotificationsCSS.navLogoLink} to="/home"><img src={ColoredLogo} className={NotificationsCSS.navLogo}></img></Link></li>
                    ...
                    <li className={NotificationsCSS.navListItem}><Link style={{ textDecoration: 'none'}} className={NotificationsCSS.navProfileLink} to="/home"><FontAwesomeIcon icon="user" className={NotificationsCSS.navProfileLogo} size='2x'/><span className={[NotificationsCSS.navUserText, NotificationsCSS.navText].join(' ')}>Profile</span></Link></li>
